...
const categories = [
  ...
  { name: "Packaging Boxes", image: "/visuals/service-packaging.png", href: "/products/boxes-cartons" },
  { name: "Brochures", image: "/visuals/service-printing.png", href: "/printing/brochures" },
  { name: "Flyers", image: "/visuals/service-printing.png", href: "/printing/flyers" },
  { name: "Booklets", image: "/visuals/service-printing.png", href: "/printing/booklets-catalogues" },
...
const featured = [
  { name: "Corporate Brochures", description: "Premium quality brochures for your brand.", image: "/visuals/service-printing.png", href: "/printing/brochures" },
  ...
  { name: "Booklets & Catalogues", description: "Perfect for product and company profiles.", image: "/visuals/service-printing.png", href: "/printing/booklets-catalogues" },
      ...
      <section className="pb-10">
        <div className="mx-auto grid max-w-7xl gap-5 px-4 lg:grid-cols-3">
          <article className="rounded-lg bg-primary p-6 text-primary-foreground shadow-md">
            ...
            <Button asChild variant="outline" className="mt-6 border-accent bg-transparent text-accent hover:bg-accent hover:text-accent-foreground"><Link href="/printing">Explore All Services <ArrowRight className="size-4" /></Link></Button>
          </article>
