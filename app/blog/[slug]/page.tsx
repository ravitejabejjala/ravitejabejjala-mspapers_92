...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main>
    ...
    <section className="bg-muted py-12"><div className="mx-auto max-w-5xl px-4"><h2 className="text-2xl font-bold text-primary">Continue exploring</h2><div className="mt-5 flex flex-wrap gap-3"><Button asChild variant="outline"><Link href="/products">Products</Link></Button><Button asChild variant="outline"><Link href="/printing-services-hyderabad">Printing Services</Link></Button><Button asChild variant="outline"><Link href="/packaging-solutions">Packaging Solutions</Link></Button><Button asChild variant="outline"><Link href="/resources">All Resources</Link></Button></div></div></section>
  </main>
}
