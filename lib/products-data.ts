...
export const mainCategories: MainCategory[] = [
  ...
  },
  {
    ...
    description: "Eco-friendly food packaging solutions for restaurants and cafes",
    icon: "Coffee",
    image: "/categories/food-beverage-packaging.jpg",
    subcategories: [
      {
        slug: "paper-cups",
        name: "Paper Cups",
        ...
        longDescription:
          "Our premium paper cups are designed for hot and cold beverages, perfect for cafes, restaurants, offices, and events. Made from food-grade materials with optional PE or PLA lining, these cups are eco-friendly and can be customized with your brand logo and design.",
        image: "/categories/paper-cups.jpg",
        icon: "Coffee",
        seoTitle: "Paper Cups | Disposable Cups | MS Paper Products Hyderabad",
        seoDescription:
          "Premium disposable paper cups for hot and cold beverages. Custom printed cups for cafes, restaurants, and events. Paper cups manufacturer in Hyderabad.",
        seoKeywords: ["paper cups", "disposable cups", "coffee cups", "tea cups", "custom printed cups"],
        products: [
          {
            id: "pc-001",
            name: "Hot Beverage Cup",
            description: "Insulated paper cup for hot drinks like coffee and tea",
            image: "/products/hot-beverage-cup.jpg",
            features: ["Double wall insulation", "Food-grade materials", "Leak-proof", "Custom printing available"],
            sizes: ["150ml", "200ml", "250ml", "350ml"],
            minOrder: "1000 pieces",
          },
          {
            id: "pc-002",
            name: "Cold Beverage Cup",
            description: "Paper cup for cold drinks, juices, and smoothies",
            image: "/products/cold-beverage-cup.jpg",
            features: ["PE lined interior", "Moisture resistant", "Vibrant printing", "Sturdy construction"],
          ...
          },
          {
            ...
            description: "Custom printed cup with your cafe or brand logo",
            image: "/products/branded-coffee-cup.jpg",
            features: ["Full color printing", "Brand customization", "Premium quality", "Matching lids available"],
            sizes: ["Small", "Medium", "Large"],
            minOrder: "2000 pieces",
          },
        ],
      ...
      {
        slug: "paper-food-boxes",
        name: "Paper Food Boxes",
        description: "Food-safe paper boxes for takeaway and delivery",
        longDescription:
        ...
        products: [
          {
            id: "pfb-001",
            name: "Meal Box",
            description: "Sturdy paper box for complete meals",
            image: "/products/meal-box.jpg",
            features: ["Leak-resistant", "Microwave safe", "Stackable design", "Custom branding"],
          ...
          },
          {
            id: "pfb-002",
            name: "Snack Box",
            description: "Compact box for snacks and finger foods",
            image: "/products/snack-box.jpg",
            features: ["Grease-resistant", "Easy assembly", "Ventilation options", "Multiple sizes"],
            sizes: ["Small", "Medium", "Large"],
            minOrder: "1000 pieces",
          },
          {
            id: "pfb-003",
            name: "Burger Box",
            description: "Clamshell box perfect for burgers and sandwiches",
            image: "/products/burger-box.jpg",
            features: ["Clamshell design", "Secure closure", "Steam vents", "Brand printing"],
            sizes: ["Standard", "Large"],
            minOrder: "1000 pieces",
          },
        ],
      },
      {
        slug: "paper-trays",
        name: "Paper Trays",
        description: "Food serving trays made from sustainable paper",
        longDescription:
          "Our paper food trays are ideal for serving fries, nachos, and other snacks. Made from food-grade paper with optional grease-resistant coating, these trays are perfect for quick-service restaurants, food trucks, and events.",
        image: "/categories/paper-trays.jpg",
        icon: "Square",
        seoTitle: "Paper Food Trays | Serving Trays | MS Paper Products",
        seoDescription:
          "Food-grade paper trays for serving and takeaway. Grease-resistant paper trays for restaurants and food service. Paper tray manufacturer in Hyderabad.",
        seoKeywords: ["paper trays", "food trays", "serving trays", "snack trays", "fry trays"],
        products: [
          {
            id: "pt-001",
            name: "Snack Tray",
            description: "Paper tray for fries, nachos, and finger foods",
            image: "/products/snack-tray.jpg",
            features: ["Grease-resistant", "Sturdy construction", "Easy to hold", "Eco-friendly"],
            sizes: ["Small", "Medium", "Large"],
            minOrder: "1000 pieces",
          },
          {
            id: "pt-002",
            name: "Combo Meal Tray",
            description: "Divided tray for combo meals with multiple items",
            image: "/products/combo-meal-tray.jpg",
            features: ["Multiple compartments", "Sturdy base", "Spill-resistant", "Custom printing"],
            sizes: ["Standard", "Large"],
            minOrder: "500 pieces",
          },
        ],
      ...
      {
        slug: "paper-bowls",
        name: "Paper Bowls & Tubs",
        description: "Disposable paper bowls for soups, salads, and ice cream",
        longDescription:
          "Our paper bowls and tubs are perfect for soups, salads, ice cream, and other food items. Made from food-safe materials with optional lining for liquids, these bowls combine functionality with eco-friendliness.",
        image: "/categories/paper-bowls.jpg",
        icon: "Circle",
        seoTitle: "Paper Bowls & Tubs | Food Containers | MS Paper Products",
        seoDescription:
          "Disposable paper bowls and tubs for food service. Soup bowls, salad bowls, ice cream tubs. Paper bowl manufacturer in Hyderabad.",
        seoKeywords: ["paper bowls", "paper tubs", "soup bowls", "salad bowls", "ice cream tubs"],
        products: [
          {
            id: "pb-001",
            name: "Soup Bowl",
            description: "Leak-proof paper bowl for hot soups",
            image: "/products/soup-bowl.jpg",
            features: ["Leak-proof lining", "Heat resistant", "Lid compatible", "Stackable"],
          ...
          },
          {
            id: "pb-002",
            name: "Salad Bowl",
            description: "Eco-friendly bowl for fresh salads",
            image: "/products/salad-bowl.jpg",
            features: ["Clear lid option", "Fresh appearance", "Recyclable", "Multiple sizes"],
            sizes: ["500ml", "750ml", "1000ml"],
            minOrder: "500 pieces",
          },
          {
            id: "pb-003",
            name: "Ice Cream Tub",
            description: "Paper tub perfect for ice cream and frozen desserts",
            image: "/products/ice-cream-tub.jpg",
            features: ["Moisture resistant", "Freezer safe", "Custom printing", "Spoon slot lid"],
      ...
      {
        slug: "paper-buckets",
        name: "Paper Buckets & Containers",
        description: "Large paper buckets and containers for food service",
        longDescription:
          "Our paper buckets and containers are ideal for large food servings such as popcorn, fried chicken, french fries, and more. Made from food-grade materials with grease-resistant options, these containers are perfect for cinemas, fast-food restaurants, and events.",
        image: "/categories/paper-buckets.jpg",
        icon: "Box",
        seoTitle: "Paper Buckets & Containers | Food Service Packaging | MS Paper Products",
        seoDescription:
          "Large paper buckets and containers for popcorn, fried chicken, and food service. Food-grade paper buckets manufacturer in Hyderabad.",
        seoKeywords: ["paper buckets", "food containers", "popcorn buckets", "chicken buckets", "paper tubs"],
        products: [
          {
            id: "pbk-001",
            name: "Popcorn Bucket",
            description: "Classic paper bucket for popcorn",
            image: "/products/popcorn-bucket.jpg",
            features: ["Grease resistant", "Custom printing", "Cinema standard sizes", "Stackable"],
            sizes: ["32oz", "64oz", "85oz", "130oz"],
            minOrder: "500 pieces",
          },
          {
            id: "pbk-002",
            name: "Fried Chicken Bucket",
            description: "Sturdy bucket for fried chicken and fast food",
            image: "/products/chicken-bucket.jpg",
            features: ["Grease-proof lining", "Ventilation holes", "Heat resistant", "Custom branding"],
            sizes: ["Medium", "Large", "Family size"],
            minOrder: "500 pieces",
          },
          {
            id: "pbk-003",
            name: "Fries Container",
            description: "Paper container for french fries and snacks",
            image: "/products/fries-container.jpg",
            features: ["Scoop design", "Grease resistant", "Easy dispensing", "Multiple sizes"],
            sizes: ["Small", "Medium", "Large"],
            minOrder: "1000 pieces",
          },
          {
            id: "pbk-004",
            name: "Multipurpose Food Bucket",
            description: "Versatile paper bucket for various food items",
            image: "/products/food-bucket.jpg",
            features: ["Lid available", "Food-safe material", "Eco-friendly", "Custom sizes"],
            sizes: ["500ml", "1L", "2L"],
            minOrder: "500 pieces",
          },
        ],
      ...
      {
        slug: "cup-holders-accessories",
        name: "Cup Holders & Accessories",
        description: "Paper cup holders, sleeves, and accessories for beverage service",
        longDescription:
          "Our cup holders and accessories complete your beverage service setup. From paper cup sleeves for hot drinks to multi-cup carriers for takeaway orders, we provide eco-friendly solutions that enhance customer experience while maintaining temperature and preventing spills.",
        image: "/categories/cup-holders-accessories.jpg",
        icon: "Coffee",
        seoTitle: "Cup Holders & Accessories | Paper Sleeves | MS Paper Products",
        seoDescription:
          "Paper cup holders, sleeves, and carriers for coffee shops and cafes. Eco-friendly beverage accessories manufacturer in Hyderabad.",
        seoKeywords: ["cup holders", "cup sleeves", "cup carriers", "coffee sleeves", "paper cup accessories"],
        products: [
          {
            id: "cha-001",
            name: "Paper Cup Sleeve",
            description: "Insulated sleeve for hot beverage cups",
            image: "/products/cup-sleeve.jpg",
            features: ["Heat insulation", "Custom printing", "Eco-friendly kraft", "Easy grip"],
          ...
          },
          {
            id: "cha-002",
            name: "2-Cup Carrier",
            description: "Sturdy carrier tray for two cups",
            image: "/products/two-cup-carrier.jpg",
            features: ["Secure hold", "Easy carrying", "Recyclable material", "Stackable design"],
            sizes: ["Standard"],
            minOrder: "1000 pieces",
          },
          {
            id: "cha-003",
            name: "4-Cup Carrier",
            description: "Heavy-duty carrier for four cups",
            image: "/products/four-cup-carrier.jpg",
            features: ["Strong construction", "Handle grip", "Spill prevention", "Brand customization"],
            sizes: ["Standard"],
            minOrder: "1000 pieces",
          },
          {
            id: "cha-004",
            name: "Cup Lid",
            description: "Paper lids for hot and cold beverage cups",
            image: "/products/cup-lid.jpg",
            features: ["Sip hole design", "Splash-proof", "Compostable options", "Multiple sizes"],
            sizes: ["Small", "Medium", "Large"],
            minOrder: "2000 pieces",
          },
        ],
  ...
  },
  {
    ...
    slug: "pharma-medical-packaging",
    description: "Specialized packaging for pharmaceutical and medical products",
    icon: "Heart",
    image: "/categories/pharma-medical-packaging.jpg",
    subcategories: [
      {
        slug: "medicine-boxes",
        name: "Medicine Boxes",
        ...
        products: [
          {
            id: "mb-001",
            name: "Medicine Carton",
            description: "Standard carton box for tablet strips and bottles",
            image: "/products/medicine-carton.jpg",
            features: ["Pharma-grade material", "Tamper-evident options", "Batch printing", "Barcode compatible"],
            sizes: ["Custom sizes available"],
            minOrder: "1000 pieces",
          },
          {
            ...
            description: "Carton designed for blister pack medicines",
            image: "/products/blister-pack-carton.jpg",
            features: ["Blister-fit design", "Product information panel", "Safety seals", "Recyclable"],
            sizes: ["As per blister size"],
            minOrder: "2000 pieces",
          },
          {
            id: "mb-003",
            name: "Syrup Box",
            description: "Sturdy box for medicine bottles and syrups",
            image: "/products/syrup-box.jpg",
            features: ["Bottle-safe design", "Insert options", "Protective structure", "Custom printing"],
            sizes: ["60ml", "100ml", "200ml bottle sizes"],
            minOrder: "1000 pieces",
          },
        ],
      },
      {
        ...
        products: [
          {
            id: "phc-001",
            name: "Bulk Medicine Carton",
            description: "Large carton for bulk medicine packaging",
            image: "/products/bulk-medicine-carton.jpg",
            features: ["Heavy-duty construction", "Stackable", "Climate protection", "Tamper-evident"],
            sizes: ["Various sizes"],
            minOrder: "500 pieces",
          },
          {
            id: "phc-002",
            name: "Medical Device Box",
            description: "Specialized box for medical devices and equipment",
            image: "/products/medical-device-box.jpg",
            features: ["Custom inserts", "ESD protection options", "Clean room compatible", "Branding options"],
            sizes: ["Custom"],
            minOrder: "300 pieces",
          },
        ],
      ...
      {
        slug: "printed-medical-packaging",
        name: "Printed Medical Packaging",
        description: "Custom printed packaging for healthcare products",
        longDescription:
          "Our printed medical packaging combines functionality with brand presentation. With precise printing capabilities for medicine information, dosage instructions, and branding, these packages meet regulatory requirements while promoting your healthcare brand.",
        image: "/categories/printed-medical-packaging.jpg",
        icon: "Printer",
        seoTitle: "Printed Medical Packaging | Custom Pharma Boxes | MS Paper Products",
        seoDescription:
          "Custom printed medical packaging with regulatory compliance. Branded pharmaceutical boxes manufacturer in Hyderabad.",
        seoKeywords: [
          "printed medical packaging",
          "custom pharma boxes",
        ...
        products: [
          {
            id: "pmp-001",
            name: "Branded Medicine Box",
            description: "Full-color printed medicine box with branding",
            image: "/products/branded-medicine-box.jpg",
            features: ["Full color printing", "Regulatory compliance", "Anti-counterfeit options", "Premium finish"],
            sizes: ["All sizes"],
            minOrder: "1000 pieces",
          },
          {
            id: "pmp-002",
            name: "Patient Information Box",
            description: "Box with detailed patient information printing",
            image: "/products/patient-info-box.jpg",
            features: ["Detailed printing", "Multiple languages", "QR code integration", "Leaflet pocket"],
  ...
  {
    name: "Food Grade Packing",
    slug: "food-grade-packing",
    description: "Premium food-safe packaging for dry fruits, grains, spices, and more",
    icon: "Package",
    image: "/categories/food-grade-packing.jpg",
    subcategories: [
      {
        slug: "transparent-window-pouches",
        name: "Transparent Window Pouches",
        description: "Food-grade pouches with clear window display for product visibility",
        longDescription:
          "Our transparent window pouches are manufactured with food-grade materials that comply with FDA and international food safety standards. The clear window allows customers to see the product inside, ensuring quality assurance and transparency. Perfect for dry fruits, grains, spices, nuts, coffee beans, tea, and other dry goods. Available in various sizes with options for custom printing on the colored portion.",
        image: "/categories/transparent-window-pouches.jpg",
        icon: "Package",
        seoTitle: "Food Grade Transparent Window Pouches | Dry Fruits & Spices Packaging | MS Paper Products",
        seoDescription:
          "Premium food-grade transparent window pouches for dry fruits, grains, spices, and nuts. FDA compliant, moisture-resistant pouches with custom printing. Bulk orders with competitive pricing.",
        seoKeywords: [
          "transparent window pouches",
          "food grade pouches",
          "dry fruits packaging",
          "spices packaging pouches",
          "grains packaging",
          "window pouches Hyderabad",
          "food safe pouches",
          "custom window pouches",
          "bulk food packaging",
        ],
        products: [
          {
            id: "fgp-001",
            name: "Dry Fruits Window Pouch",
            description: "Premium pouch with transparent window for dry fruits display",
            image: "/categories/transparent-window-pouches.jpg",
            features: [
          ...
          {
            id: "fgp-002",
            name: "Spices Packaging Pouch",
            description: "Aroma-lock pouches with window for spices and seasonings",
            image: "/categories/transparent-window-pouches.jpg",
            features: [
              "Aroma-seal technology",
          ...
          {
            id: "fgp-003",
            name: "Grains & Pulses Pouch",
            description: "Large capacity pouches for grains, pulses, and cereals",
            image: "/categories/transparent-window-pouches.jpg",
            features: [
          ...
          {
            id: "fgp-004",
            name: "Nuts & Seeds Pouch",
            description: "Premium pouch with oxygen barrier for nuts and seeds preservation",
            image: "/categories/transparent-window-pouches.jpg",
            features: [
          ...
          {
            id: "fgp-005",
            name: "Coffee & Tea Pouch",
            description: "Specialized pouch with degassing valve for coffee and tea",
            image: "/categories/transparent-window-pouches.jpg",
            features: [
          ...
          {
            id: "fgp-006",
            name: "Herbs & Seasonings Pouch",
            description: "Compact pouches for dried herbs and seasoning mixes",
            image: "/categories/transparent-window-pouches.jpg",
            features: [
              "Compact size options",
              "Moisture-proof seal",
              "Clear window for product showcase",
              "Food-grade printing",
      ...
      {
        slug: "stand-up-pouches-food-grade",
        name: "Stand-Up Food Pouches",
        description: "Premium stand-up pouches with window for retail display",
        longDescription:
          "Our stand-up food pouches are designed to maximize shelf visibility while maintaining product freshness. With the integrated window and gusset base, these pouches stand upright on shelves, making them ideal for retail environments. Available with zip-lock closure, heat seal bottom, and customizable printing options. Perfect for premium food products that demand professional presentation.",
        image: "/categories/food-grade-packing.jpg",
        icon: "Package",
        seoTitle: "Stand-Up Food Grade Pouches | Retail Food Packaging | MS Paper Products",
        seoDescription:
          "Premium stand-up food grade pouches with transparent window. Perfect for dry fruits, grains, nuts, and coffee. FDA compliant with custom printing for retail display.",
        seoKeywords: [
          "stand-up pouches",
          "food grade pouches",
          "retail food packaging",
          "stand-up food bags",
          "window pouches for retail",
        ...
        products: [
          {
            id: "sup-001",
            name: "Small Stand-Up Pouch",
            description: "Compact stand-up pouch with transparent window",
            image: "/categories/food-grade-packing.jpg",
            features: ["Transparent window", "Zip-lock closure", "Food-grade material", "Heat-sealed bottom"],
            sizes: ["50g", "100g", "200g"],
            minOrder: "1000 pieces",
          },
          {
            id: "sup-002",
            name: "Medium Stand-Up Pouch",
            description: "Medium capacity stand-up pouch for premium products",
            image: "/categories/food-grade-packing.jpg",
            features: ["Gusset bottom", "Large window", "Custom printing", "Professional appearance"],
            sizes: ["250g", "500g"],
            minOrder: "500 pieces",
          },
          {
            id: "sup-003",
            name: "Large Stand-Up Pouch",
            description: "Large capacity pouch for bulk food products",
            image: "/categories/food-grade-packing.jpg",
            features: ["Large transparent window", "Strong sealing", "Bulk capacity", "Wholesale pricing"],
            sizes: ["1kg", "2kg"],
            minOrder: "500 pieces",
          },
        ],
      ...
      {
        slug: "food-grade-labels",
        name: "Food Grade Adhesive Labels",
        description: "Premium food-safe labels for product identification and branding",
        longDescription:
          "Our food-grade adhesive labels are specifically designed for food packaging applications, meeting all FDA and international food safety regulations. Perfect for labeling pouches, boxes, and containers with product name, ingredients, nutritional information, and branding. Available in various materials including glossy, matte, and thermal transfer options.",
        image: "/categories/food-grade-packing.jpg",
        icon: "Package",
        seoTitle: "Food Grade Adhesive Labels | FDA Compliant Labels | MS Paper Products",
        seoDescription:
          "Premium food-grade adhesive labels for food packaging. FDA compliant, water-resistant labels with custom printing. Perfect for dry fruits, spices, grains packaging.",
        seoKeywords: [
          "food grade labels",
          "adhesive labels food",
        ...
        products: [
          {
            id: "fgl-001",
            name: "Glossy Food Labels",
            description: "Premium glossy labels for food products",
            image: "/categories/food-grade-packing.jpg",
            features: ["FDA compliant", "Water-resistant", "Full color printing", "Glossy finish"],
            sizes: ["Custom sizes"],
            minOrder: "1000 labels",
          },
          {
            id: "fgl-002",
            name: "Matte Food Labels",
            description: "Professional matte finish labels for food packaging",
            image: "/categories/food-grade-packing.jpg",
            features: ["Premium matte finish", "Anti-glare", "Food-safe adhesive", "Custom design"],
            sizes: ["Custom sizes"],
            minOrder: "1000 labels",
          },
        ],
