...
export const mainCategories: MainCategory[] = [
  ...
  {
    name: "Ecommerce & Logistics Solutions",
    slug: "ecommerce-logistics",
    description: "Premium packaging and labeling solutions for ecommerce and logistics businesses",
    icon: "Truck",
    subcategories: [
      {
        slug: "courier-covers",
        name: "Ecommerce Courier Covers",
        description: "Professional waterproof courier covers for safe package delivery",
        longDescription:
          "Our ecommerce courier covers are specifically designed for high-volume shipping operations. Made from premium quality LDPE (Low-Density Polyethylene) material, these covers provide excellent protection against water, dust, and physical damage during transit. Available in various sizes with custom branding options, they are ideal for ecommerce businesses, logistics companies, and courier services looking to enhance their brand presence while ensuring package safety.",
        image: "/products/courier-covers-hero.png",
        icon: "Package",
        seoTitle: "Ecommerce Courier Covers | Waterproof Shipping Bags | MS Paper Products Hyderabad",
        seoDescription:
          "Premium ecommerce courier covers and waterproof shipping bags in Hyderabad. Durable LDPE material, custom printing, bulk orders welcome. Fast delivery guaranteed.",
        seoKeywords: [
          "courier covers",
          ...
          "bulk shipping bags",
          "branded courier bags",
          "custom courier covers",
          "ecommerce packaging",
          "logistics solutions",
        ],
        products: [
          ...
          {
            id: "ec-003",
            name: "Large Courier Cover",
            description: "Heavy-duty courier cover for large shipments",
            image: "/products/courier-covers-hero.png",
            features: [
            ...
            sizes: ["14x20 inches", "16x24 inches"],
            minOrder: "500 pieces",
          },
          {
            id: "ec-004",
            name: "Branded Courier Covers",
          ...
          {
            id: "ec-005",
            name: "Eco-Friendly Courier Covers",
      ...
      {
        slug: "shipping-barcode-labels",
        name: "Shipping Barcode Labels Rolls",
        description: "High-quality thermal shipping barcode label rolls for logistics and ecommerce",
        longDescription:
          "Our shipping barcode label rolls are designed for high-speed thermal printing, perfect for busy logistics operations and ecommerce warehouses. Made from premium quality paper with excellent adhesive properties, these labels provide clear barcode scanning and are compatible with all major thermal label printers. With multiple size options and customization available, they help streamline your shipping operations while maintaining professional standards.",
        image: "/products/barcode-labels.png",
        icon: "BarChart3",
        seoTitle: "Shipping Barcode Labels Rolls | Thermal Labels | MS Paper Products Hyderabad",
        seoDescription:
          "Premium thermal shipping barcode label rolls for ecommerce and logistics. 4x6 labels, self-adhesive, fast scanning, bulk orders. Direct manufacturer in Hyderabad.",
        seoKeywords: [
          "barcode label rolls",
          "shipping labels",
          "thermal labels",
        ...
        products: [
          ...
          {
            id: "sbl-003",
            name: "6x8 Large Shipping Labels",
          ...
          {
            id: "sbl-005",
            name: "Waterproof Barcode Labels",
          ...
          {
            id: "sbl-006",
            name: "Fluorescent Barcode Labels",
